...
fsi_data_reg <- reactiveVal(NULL)
civil_lib_data_reg <- reactiveVal(NULL)
stability_data_reg <- reactiveVal(NULL)
rol_data_reg <- reactiveVal(NULL)
elect_data_reg <- reactiveVal(NULL)
regime_data_reg <- reactiveVal(NULL)
gdp_growth_data_reg <- reactiveVal(NULL)
gni_pc_data_reg <- reactiveVal(NULL)
hdi_data_reg <- reactiveVal(NULL)
gii_data_reg <- reactiveVal(NULL)
climate_change_data_reg <- reactiveVal(NULL)
risk_index_data_reg <- reactiveVal(NULL)
cpi_data_reg <- reactiveVal(NULL)
fhfgi_data_reg <- reactiveVal(NULL)
...
ccsi_data_reg <- reactiveVal(NULL)
bready_resolution_data_reg <- reactiveVal(NULL)
...
observeEvent(input$fetch_data_reg, {
  ...
  if (!is.null(stability_df) && nrow(stability_df) > 0) {
    stability_data_reg(stability_df)
  ...
  if (!is.null(civil_lib_df) && nrow(civil_lib_df) > 0) {
    civil_lib_data_reg(civil_lib_df)
  ...
  if (!is.null(b_1_gdp_growth_df) && nrow(b_1_gdp_growth_df) > 0) {
    gdp_growth_data_reg(b_1_gdp_growth_df)
  ...
  if (!is.null(b_3_climate_change_df) && nrow(b_3_climate_change_df) > 0) {
    climate_change_data_reg(b_3_climate_change_df)
  ...
  if (!is.null(c_1_risk_index_df) && nrow(c_1_risk_index_df) > 0) {
    risk_index_data_reg(c_1_risk_index_df)
  ...
  if (!is.null(c_3_oda_gni_df) && nrow(c_3_oda_gni_df) > 0) {
    oda_gni_data_reg(c_3_oda_gni_df)
  ...
  if (!is.null(c_4_bready_resolution_df) && nrow(c_4_bready_resolution_df) > 0) {
    bready_resolution_data_reg(c_4_bready_resolution_df)
