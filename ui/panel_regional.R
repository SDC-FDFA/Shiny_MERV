panel_regional <- nav_panel(
  ...
  page_sidebar(sidebar = sidebar(
    ...
    checkboxGroupInput("comparison_countries", "Select Countries:", choices = country_list, selected = c("KHM", "THA")),
  ...
  div(
    ...
    div(
      ...
      withSpinner(girafeOutput("elect_plot_reg", width = "100%", height = "300px"),
